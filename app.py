...
from dbutils import db_connect #conecte y devuelve coleccion
from dbutils import db_insert_user #inserta un usuario
from dbutils import db_find_all #devuelve usuarios de la conexion
